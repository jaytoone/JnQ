...
def profitage(Coin, long_signal_value, short_signal_value, long_period, short_period, wait_tick=3, Date='2019-09-25',
    ...
    for i in range(2, len(df)):
        ...
        #       1M FISHER LONG POSITION FINDING     #
        ...
        if df['Fisher_long'].iloc[i] >= short_signal_value:
    ...
    while m <= length:  # 초반 시작포인트 찾기
        ...
        while True:
            ...
            if exit_signal == 1 and df['Fisher_long'].iloc[m] < 0.2:
                exit_switch = True
                break
...
if __name__ == "__main__":
    ...
    # print(TopCoin)
    # quit()
    TopCoin = ['MIX', 'EL', 'APIX', 'QKC', 'WPX', 'MIX']
    # TopCoin = ['APIX', 'QBZ']
