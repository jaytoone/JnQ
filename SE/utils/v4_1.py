...
def enlist_epouttp(res_df, tp_gap):
    ...
    short_out = res_df['st_lower3_5m'] - res_df['st_gap_5m'] * tp_gap   # long (short inversion)
    long_out = res_df['st_upper3_5m'] + res_df['st_gap_5m'] * tp_gap

    # --------------- st level tp --------------- #
    short_tp = res_df['st_upper2_5m']   # long (short inversion)
    long_tp = res_df['st_lower2_5m']
