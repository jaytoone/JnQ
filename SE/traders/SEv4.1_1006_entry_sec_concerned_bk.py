    ...
    def run(self):
        ...
        while 1:
            ...
            while 1:
                ...
                if open_side is not None and check_entry_sec < 3:
                ...
                # ------- open_size is None [ waiting zone ] ------- #
                else:
                ...
                while 1:
                    ...
                    if order.tp_type == OrderType.LIMIT:
                        ...
                        if load_new_df2:    # dynamic out / tp 를 위함
                            ...
                            try:
                                ...
                                print('error in get new_dfs (limit tp phase) :', e)
                                continue
                    ...
                    #               market close phase - get market signal               #
                        ...
                        while 1:  # <--- This loop for out close & complete close
                            ...
                            #           2. reduceOnly = 'true'       #
                            try:
                                if not order.out_type == OrderType.MARKET:
