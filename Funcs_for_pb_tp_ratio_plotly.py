...
def profitage(df, second_df, third_df, fourth_df=None, symbol=None, date=None, save_path=None, excel=0, get_fig=0, only_profit=False, show_time=False, label_type='Test'):
