...
class Shield(ShieldModule):
    ...
    """
    v2_7_2_2 -> v2_7_2_2_1
        1. update module (adjust v3_3x)
        2. turn off enlist_tr logging.
    """
    ...
    def __init__(self, paper_name, main_name, id_zip, config_type, mode="Bank", shield_close=None):
        ...
        # 14. ML params.
        valid_data_path = r"D:\Projects\System_Trading\JnQ\database\binance\ML\wrr32_03\long\tr_non_fix\static_lvrg\res\200_6\random_index_99_100.pkl"
