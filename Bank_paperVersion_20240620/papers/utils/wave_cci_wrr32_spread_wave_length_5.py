...
def enlist_tr(res_df, tp, ep, out, config, np_timeidx, mode='OPEN', show_detail=True):
    ...
    res_df['short_tp_1_{}'.format(selection_id)] = tp
    res_df['short_tp_0_{}'.format(selection_id)] = out
    res_df['long_tp_1_{}'.format(selection_id)] = tp
    res_df['long_tp_0_{}'.format(selection_id)] = out

    res_df['short_ep1_1_{}'.format(selection_id)] = tp
    res_df['short_ep1_0_{}'.format(selection_id)] = out
    res_df['long_ep1_1_{}'.format(selection_id)] = tp
    res_df['long_ep1_0_{}'.format(selection_id)] = out

    # --> p2's ep use p1's ep
    res_df['short_ep2_1_{}'.format(selection_id)] = tp
    res_df['short_ep2_0_{}'.format(selection_id)] = out
    res_df['long_ep2_1_{}'.format(selection_id)] = tp
    res_df['long_ep2_0_{}'.format(selection_id)] = out

    # --> out use p1's low, (allow prev_low as out for p1_hhm only)
    res_df['short_out_1_{}'.format(selection_id)] = tp
    res_df['short_out_0_{}'.format(selection_id)] = out
    res_df['long_out_1_{}'.format(selection_id)] = tp
    res_df['long_out_0_{}'.format(selection_id)] = out

    res_df['short_out2_1_{}'.format(selection_id)] = wave_low_fill1_  # wave_low_fill1_ b2_low_5T
    res_df['short_out2_0_{}'.format(selection_id)] = roll_highs1[-1]  # roll_highs1[-1] wave_high_fill1_
    res_df['long_out2_1_{}'.format(selection_id)] = wave_high_fill1_  # wave_high_fill1_ b2_high_5T
    res_df['long_out2_0_{}'.format(selection_id)] = roll_lows1[-1]  # roll_lows1[-1]  wave_low_fill1_
    ...
    res_df['short_out2_gap_{}'.format(selection_id)] = abs(res_df['short_out2_1_{}'.format(selection_id)] - res_df['short_out2_0_{}'.format(selection_id)])
    res_df['long_out2_gap_{}'.format(selection_id)] = abs(res_df['long_out2_1_{}'.format(selection_id)] - res_df['long_out2_0_{}'.format(selection_id)])
    ...
    #        -i. fixed tp.
    res_df['short_tp_{}'.format(selection_id)] = tp
    res_df['long_tp_{}'.format(selection_id)] = tp
    ...
    if config.ep_set.entry_type == "LIMIT":
        epg1 = config.tr_set.ep_gap

        #             -i. fixed ep1.
        res_df['short_ep1_{}'.format(selection_id)] = ep
        res_df['long_ep1_{}'.format(selection_id)] = ep
        ...
        # res_df['short_ep1_{}'.format(selection_id)] = res_df['short_tp_1_{}'.format(selection_id)].to_numpy() - res_df[
    ...
    if config.ep_set.point2.entry_type == "LIMIT":
        ...
        #             -i. fixed ep2.
        res_df['short_ep2_{}'.format(selection_id)] = ep
        res_df['long_ep2_{}'.format(selection_id)] = ep
    ...
    if config.tr_set.check_hlm == 0:
        ...
        #     -i. fixed out.
        res_df['short_out_{}'.format(selection_id)] = out
        res_df['long_out_{}'.format(selection_id)] = out

        res_df['short_out2_{}'.format(selection_id)] = res_df['short_out2_0_{}'.format(selection_id)].to_numpy() + res_df['short_out2_gap_{}'.format(selection_id)].to_numpy() * outg2
        res_df['long_out2_{}'.format(selection_id)] = res_df['long_out2_0_{}'.format(selection_id)].to_numpy() - res_df['long_out2_gap_{}'.format(selection_id)].to_numpy() * outg2
