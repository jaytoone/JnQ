...
u_name_list = ["{}.utils.{}_utils_{}_modulize".format(strat_pkg, frame_ver, id_) for id_ in ID_list]
utils_list = [importlib.import_module(u_name) for u_name in u_name_list]

# ------- config ------- #
config_name_list = ["{}_config_{}_modulize.json".format(frame_ver, id_) for id_ in ID_list]
