            ...
            if open_executedQty == 0.0:  # open_executedQty 는 분명 정의됨
                ...
                while 1:
                        ...
                        while 1:
                            try:
                                post_order_res_list = partial_limit_order_v2(self, self.config, tp_list, close_side,
                                                                             ...
                                                                             self.config.tp_set.partial_qty_divider, reduceOnly=False)
                            except Exception as e:
                    ...
                    if not market_close_on:  # = load_new_df2
                        ...
                        close_executedPrice_list = market_close_order(self, self.config, remain_tp_canceled,
                                                                      post_order_res_list, close_side, open_executedQty, out, log_tp, reduceOnly=False)
