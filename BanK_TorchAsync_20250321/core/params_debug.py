...
v0.4.2.1
  - add leverage_limit_const. 20250415 0045.
  - add RRratio. 20250427 0923.
"""
...
params = {
    ...
    ###### Starter ######
    'CCIMAGapBandLong': 50,
    'CCIMAGapBandShort': 50,

    ###### Anchor ######
    'RRratio_adj_fee_upper': 0.9,
    'RRratio_adj_fee_lower': 0.8,
        
    # BBCandleBodyRatio (%)
    'BBCandleBodyRatio_upper_long': 200,
    'BBCandleBodyRatio_lower_long': 50,
    'BBCandleBodyRatio_upper_short': 200,
    'BBCandleBodyRatio_lower_short': 50,

    # Candle Body (%)
    'bodyPctUpper_long': 100,
    'bodyPctLower_long': 60,
    'bodyPctUpper_short': 100,
    'bodyPctLower_short': 60,

    # Candle Wick (%)
    'wickPctUpper_long': 40,
    'wickPctLower_long': 0,
    'wickPctUpper_short': 40,
    ...
    ###### Momentum ######
    'DCmmt_const_long_max': 100,
    'DCmmt_const_long_min': 0,
    'DCmmt_const_short_max': 100,
    'DCmmt_const_short_min': 0,
    ...
    'leverage_limit_const': 15,   # margin 소화가 가능하겠다고 생각하는 유효 범위를 본인이 선택한다.
