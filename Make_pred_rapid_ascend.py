...
import os
from Make_X_rapid_ascend import made_x, made_x_origin
...
if __name__ == '__main__':
    ...
    # ohlcv_list = ['2019-10-09 PIVX ohlcv.xlsx']
    ...
    for file in ohlcv_list:
        ...
        try:
            X_test, _, sliced_ohlc = made_x(file, input_data_length, model_num, check_span, Range_fluc=0.4, get_fig=0, crop_size=crop_size)
            X_test2, _, sliced_ohlc2 = made_x(file, input_data_length, model_num, check_span, Range_fluc=0.4, get_fig=0, crop_size=crop_size2)
