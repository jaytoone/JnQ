...
class Kiwoom(QAxWidget):
    ...
    def event_connect(self, return_code):
        ...
        try:
            ...
            try:
                print("login_loop.exit() executed.")
                ...
                if return_code != ReturnCode.OP_ERR_NONE:
                    try:
                        for loop in [self.request_loop, self.order_loop, self.condition_loop]:
                            loop.exit()
                    except:
                        pass
