from funcs.binance.futures_configuration import *
import math
import pandas as pd
# import time
...
if __name__ == '__main__':
    ...
    # res_obj = request_client.post_order(symbol=symbol, side=open_side,
    ...
    result = request_client.get_order(symbol, orderId=19420890060)
