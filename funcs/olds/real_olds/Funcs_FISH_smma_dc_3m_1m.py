...
def profitage(Coin, long_signal_value, short_signal_value, long_period, short_period, wait_tick=3, Date='2019-09-25',
    ...
    if not Coin.endswith('.xlsx'):
        df = pybithumb.get_ohlcv(Coin, 'KRW', 'minute1')
        df_short = pybithumb.get_ohlcv(Coin, 'KRW', 'minute5')
...
if __name__ == "__main__":
    ...
    # print(TopCoin)
    # quit()
    TopCoin = ['APIX', 'EGG', 'PCM', 'LRC', 'SOC', 'VALOR', 'EM']
    # TopCoin = ['BASIC', 'HYC', 'XSR', 'WET', 'EGG', 'PCM']
    # TopCoin = ['THETA', 'QKC', 'WPX', 'MIX']
    # TopCoin = ['APIX', 'QBZ']
