...
def low_high(reg_target, model, crop_size=0, C=None, gamma=None, epsilon=None, chart=0):
...
def profitage(Coin, reg_target, short, long, signal, C, gamma, epsilon, model, crop_size, Date='2019-09-25', excel=0, get_fig=0):
    ...
    # print(df[reg_target])
    # quit()
    osc_reg, trade_state = low_high(df[reg_target], model, crop_size, C, gamma, epsilon, chart=0)
