...
class ShieldModule(UpbitModule):
    ...
    def __init__(self, config):
        api_key, secret_key = self.load_key(r"D:\Projects\System_Trading\JnQ\Bank\api_keys\upbit_key.pkl")
    ...
    def check_open_exec_qty_v2(self, post_order_res, open_quantity):
        ...
        open_exec = (abs(self.get_exec_qty(order_info) / open_quantity) >= self.config.trader_set.open_exec_qty_ratio) or order_info['status'] == "done"
        return open_exec
