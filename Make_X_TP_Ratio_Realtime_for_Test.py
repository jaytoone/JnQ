...
def made_x(file, input_data_length, scale_window_size, data_amount=0):
...
if __name__ == '__main__':
    ...
    dir = './Labeled_Data/TP_Ratio_Test/'
    selected_date = '12-09'
    ...
    for file in ohlcv_list:
        ...
        try:
            result = made_x(file, input_data_length, scale_window_size, data_amount)
            # print(result)
            # quit()
            ...
            np.save('./Made_X/Made_Z %s' % model_num, np.array(Made_Z))
            # quit()
            # continue
