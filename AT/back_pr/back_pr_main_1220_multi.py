...
if __name__ == "__main__":
    ...
    log_name = "ETHUSDT_1640087069.pkl"
    save_xlsx = 1

    #       trader_name - exist for matching trade_log dir      #
    from AT.bots.bot_v3n5_2_1216 import trader_name, utils_list, config_list

    strat_name = "AT.back_pr.back_pr_strat.back_v3n5_2.py".replace(".py", "")
    ...
    # utils_lib_list = [utils_public_lib, utils1_lib, utils2_lib]
    ...
    if not history:
        ...
        # start_datetime = pd.to_datetime(str("2021-12-18 15:49:59.999000"))
