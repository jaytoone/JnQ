...
if __name__ == "__main__":
    ...
    #       Todo       #
    #        1. match bot name      #
    from AT.bots.bot_v3n5_2n7_3_0101_mrlog import trader_name, utils_list, config_list

    dir_path = os.getcwd()
    # print("os.getcwd() :", os.getcwd())

    #       Todo       #
    #        2. match back_strat. name      #
    strat_name = "AT.back_pr.back_pr_strat.back_v3n5_2n7_3.py".replace(".py", "")
    ...
    # else:
    #       log variables       #
    log_name = "ETHUSDT_1641117049.pkl"

    config1_name, config2_name, config3_name = config_list
    ...
    cfg_full_path3 = os.path.join(dir_path, "config", config3_name)
    ...
    with open(cfg_full_path3) as cfg:
    ...
    open_list, ep_tp_list, trade_list, side_list, strat_ver_list = \
        strat_lib.back_pr_check(res_df, save_path, config_list, utils_list, config.trader_set.symbol)
