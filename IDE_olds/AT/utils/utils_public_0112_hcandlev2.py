...
def short_ep_loc(res_df, config, i, np_timeidx, show_detail=True):
    ...
    if config.loc_set.point.candle_ratio != "None":
        ...
        if strat_version in ['v5_2', '1_1']:
            ...
            if show_detail:
                sys_log3.warning("candle_ratio_0 : {:.3f} <= {:.3f}".format(candle_ratio_, -config.loc_set.point.candle_ratio))
        ...
        if strat_version in ['v7_3', '2_2', 'v3']:
            ...
            if prev_hclose_idx >= 0:
                ...
                if strat_version in ['v7_3']:
                    ...
                    if show_detail:
                        sys_log3.warning("candle_ratio1 : {:.3f} <= {:.3f}".format(total_ratio, -config.loc_set.point.candle_ratio))

                    if total_ratio <= -config.loc_set.point.candle_ratio:
                        pass
                    else:
                        return res_df, open_side, zone
                    ...
                    if show_detail:
                        sys_log3.warning("candle_ratio1 : {:.3f} <= {:.3f}".format(h_candle_ratio_, -config.loc_set.point.candle_ratio))
                    ...
                    if config.loc_set.point.body_ratio != "None":
                        ...
                        if show_detail:
                            sys_log3.warning("body_ratio1 : {:.3f} >= {:.3f}".format(h_body_ratio_, config.loc_set.point.body_ratio))
    ...
    if config.loc_set.point.candle_ratio2 != "None":
        ...
        if prev_hclose_idx >= -1:
            ...
            if show_detail:
                sys_log3.warning("candle_ratio2 : {:.3f} <= {:.3f}".format(score, -config.loc_set.point.candle_ratio2))
            ...
            if config.loc_set.point.body_ratio2 != "None":
                ...
                if show_detail:
                    sys_log3.warning("body_ratio2 : {:.3f} >= {:.3f}".format(body_score, config.loc_set.point.body_ratio2))
    ...
    if config.loc_set.zone.short_spread != "None":
        ...
        if show_detail:
            sys_log3.warning("spread : {:.3f} >= {:.3f}".format(spread, config.loc_set.zone.short_spread))
    ...
    if config.loc_set.zone.dt_k != "None":
        ...
        if config.loc_set.zone.dtk_dc_itv != "None":
            ...
            if show_detail:
                sys_log3.warning("dc >= dt_k : {:.3f} >= {:.3f}".format(dc, dt_k))
    ...
    if config.loc_set.zone.zone_rejection:
        ...
        if strat_version in ['v5_2']:
            ...
            if show_detail:
                sys_log3.warning("bb_upper2_ & close : {:.3f} < {:.3f}".format(bb_, close_))
        ...
        if strat_version in ['v7_3', '1_1']:
            ...
            if show_detail:
                sys_log3.warning("bb_upper_5m & bb_base_ : {:.3f} < {:.3f}".format(bb_, bb_1))
            ...
            if show_detail:
                sys_log3.warning("bb_upper_5m & short_ep_ : {:.3f} > {:.3f}".format(bb_, ep_))
            ...
            if prev_hopen_idx >= 0:
                ...
                if show_detail:
                    sys_log3.warning("bb_upper_15m & dc_upper_5m : {:.3f} > {:.3f}".format(bb_, dc_))
        ...
        if strat_version in ['v7_3', '1_1']:
            ...
            if show_detail:
                sys_log3.warning("dc_upper_5m & ema_5m : {:.3f} < {:.3f}".format(dc_, ema_))
        ...
        if strat_version in ['v5_2', 'v3']:
            ...
            if show_detail:
                sys_log3.warning("close & ema_5m : {:.3f} > {:.3f}".format(close_, ema_))
            ...
            # if show_detail:
            #   sys_log3.warning("bb_upper_30m & ema_5m : {:.3f} > {:.3f}".format(bb_, ema_))
            #
            # if ema_ < bb_:
            #   pass
            # else:
        ...
        #       if show_detail:
        #         sys_log3.warning("close & st : {:.3f} {:.3f}".format(bb_, bb_1))
    ...
    if config.tr_set.c_ep_gap != "None":
        ...
        if show_detail:
            sys_log3.warning("zone_dc_upper_v2_ & long_dtk_plot_ : {:.3f} > {:.3f}".format(zone_dc_, l_dtk_))
...
def long_ep_loc(res_df, config, i, np_timeidx, show_detail=True):
            ...
            if prev_hclose_idx >= 0:
                ...
                if strat_version in ['v7_3']:
                    ...
                    if config.loc_set.point.body_ratio != "None":
                        ...
                        if show_detail:
                            sys_log3.warning("body_ratio1 : {:.3f} >= {:.3f}".format(h_body_ratio_, config.loc_set.point.candle_ratio))
    ...
    if config.loc_set.zone.long_spread != "None":
        ...
        if show_detail:
            sys_log3.warning("spread : {:.3f} >= {:.3f}".format(spread, config.loc_set.zone.long_spread))
    ...
    if config.loc_set.zone.dt_k != "None":
        ...
        if config.loc_set.zone.dtk_dc_itv != "None":
            ...
            if show_detail:
                sys_log3.warning("dc : {:.3f} <= {:.3f}".format(dc, dt_k))
    ...
    if config.loc_set.zone.zone_rejection:
        ...
        if strat_version in ['v5_2']:
            ...
            if show_detail:
                sys_log3.warning("bb_lower2_ & close : {:.3f} > {:.3f}".format(bb_, close_))
        ...
        if strat_version in ['v7_3', '1_1']:
            ...
            if show_detail:
                sys_log3.warning("bb_lower_5m & bb_base_ : {:.3f} > {:.3f}".format(bb_, bb_1))
            ...
            if show_detail:
                sys_log3.warning("bb_lower_5m & long_ep_ : {:.3f} < {:.3f}".format(bb_, ep_))
            ...
            if prev_hopen_idx >= 0:
                ...
                if show_detail:
                    sys_log3.warning("bb_lower_15m & dc_lower_5m : {:.3f} < {:.3f}".format(bb_, dc_))
        ...
        if strat_version in ['v7_3', '1_1']:
            ...
            if show_detail:
                sys_log3.warning("dc_lower_5m & ema_5m : {:.3f} > {:.3f}".format(dc_, ema_))
        ...
        if strat_version in ['v5_2', 'v3']:
            ...
            if close_ > ema_:
                ...
                # if show_detail:
            #     sys_log3.warning("bb_lower_30m & ema_5m : {:.3f} < {:.3f}".format(bb_, ema_))
        ...
        #       if show_detail:
        #         sys_log3.warning("close & ema : {:.3f} {:.3f}".format(bb_, bb_1))
    ...
    if config.tr_set.c_ep_gap != "None":
        ...
        if show_detail:
            sys_log3.warning("zone_dc_lower_v2_ & short_dtk_plot : {:.3f} < {:.3f}".format(zone_dc_, l_dtk_))
