...
import os
from Make_X_rapid_ascend_detail import made_x
...
if __name__ == '__main__':
    ...
    # ohlcv_list = ['2019-10-14 MTL ohlcv.xlsx']
    ...
    for file in ohlcv_list:
        ...
        try:
            X_test, _, sliced_ohlc = made_x(file, input_data_length, model_num, check_span, 0, crop_size=crop_size)
            ...
            X_test = X_test.astype('float32').reshape(-1, row, col, 1)[:, :, [0, 1, 2, 3, 4, 7]]
            ...
            if len(X_test) != 0:
                ...
                for i in range(len(Y_pred_)):
                    if Y_pred_[i][1] > max_value[1] * 0.9:
                        Y_pred[i] = 1
                    elif Y_pred_[i][2] > max_value[2] * 0.9:
                        Y_pred[i] = 2
