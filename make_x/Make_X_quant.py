...
from funcs.funcs_for_trade import to_higher_candlestick
...
if __name__ == '__main__':
    ...
    from funcs.funcs_for_pb_tp_ratio_plotly_idea_candle_chg import profitage
    ...
    # for end_date in ['2020-12-%02d' % i for i in range(1, 30)]:
    ...
    second_df = to_higher_candlestick(first_df, 3)
    third_df = to_higher_candlestick(first_df, 15)
