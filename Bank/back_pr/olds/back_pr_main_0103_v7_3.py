...
if __name__ == "__main__":
    ...
    #       Todo       #
    #        1. match bot name      #
    from Banking.bots.bot_v3n5_2n7_3_0112_hcandlev2 import trader_name, utils_list, config_list
    ...
    strat_name = "AT.back_pr.back_id.0114_htf_back_id_v3_v5_2_v7_3.py".replace(".py", "")
    ...
    open_list, ep_tp_list, trade_list, side_list, strat_ver_list = \
        strat_lib.back_pr_check(res_df, png_save_path, config_list, utils_list, config.trader_set.symbol)
