from funcs.public.broker import calc_tp_out_fee
from funcs.olds.funcs_indicator_candlescore import *
from funcs.public.idep import sharpe_ratio, frq_dev_plot
...
def back_pr_check(ftr_path, ftr_list, bot_lib, config_list, show_plot=0, title_pos_y=0.5):
    ...
    config = config_list[0]  # custom base config, if use override -> set to config[0]
