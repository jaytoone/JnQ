...
def enlist_tr(res_df, config, np_timeidx, mode='OPEN', show_detail=True):
    ...
    res_df['short_ep1_0_{}'.format(selection_id)] = wave_high_fill1_  # wave_high_fill1_  # roll_high_[:, -2]
    res_df['long_ep1_1_{}'.format(selection_id)] = wave_high_fill1_  # wave_high_fill1_   # b2_high_5T
    res_df['long_ep1_0_{}'.format(selection_id)] = wave_low_fill1_  # wave_low_fill1_    # roll_low_[:, -2]
