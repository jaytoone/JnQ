"""
trader_v1
1. wave_cci_wrr_32_wave_length 를 위한 basic structure 를 가지고 있음.
2. 0717_5_47 의 실행 경험을 code_copy 함.
"""
...
class Trader:
    def __init__(self, public, utils_list, config_name_list):
        # ------ ID info. ------ #
        self.utils_public = public
    ...
    def run(self):
        ...
        sys_log_path, trade_log_path, df_log_path = [os.path.join(pkg_path, "logs", path_, exec_file_name) for path_ in
                                                     log_path_list]
