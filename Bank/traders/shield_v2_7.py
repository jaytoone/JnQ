        ...
        try:
            ...
            with open(data_path, 'rb') as f:
                ...
                for code, watch_data in self.watch_data_dict.copy().items():
                    ...
                    watch_code_dict[code] = {'open_side_msg': watch_data['open_side_msg']}
        ...
        try:
            ...
            with open(data_path, 'rb') as f:
                ...
                for code, open_remain_data in self.open_remain_data_dict.copy().items():
                    ...
                    watch_code_dict[code] = {'open_side_msg': open_remain_data['open_side_msg']}
        ...
        try:
            ...
            with open(data_path, 'rb') as f:
                ...
                for code, close_remain_data in self.close_remain_data_dict.copy().items():
                    ...
                    watch_code_dict[code] = {'open_side_msg': close_remain_data['open_side_msg']}
            ...
            if not self.config.trader_set.backtrade:
                    ...
                    if self.user_text is not None:
                        ...
                        if len(payload) == 2:
                            ...
                            if code in valid_code_list and open_side_msg in [OrderSide.BUY, OrderSide.SELL]:
                                watch_code_dict[code] = {'open_side_msg': open_side_msg}
                ...
                #       ii. Messenger off 시, default code = self.config.trader_set.symbol
                    ...
                    if len(self.watch_data_dict) == 0:
                        ...
                        watch_code_dict[symbol] = {'open_side_msg': open_side_msg}
