...
class Trader:
    ...
    def __init__(self, paper_name, id_list, backtrade=False, mode="Trader"):
                ...
                if open_side is not None:
                    ...
                    if self.config.ep_set.entry_type == "MARKET" and not self.config.trader_set.backtrade:
                        ...
                        if check_entry_sec > self.config.trader_set.check_entry_sec:
                            open_side = None
                            self.sys_log.warning("check_entry_sec : {}".format(check_entry_sec))
                    ...
                    if self.config.trader_set.backtrade:
                        ...
                        while 1:
                            ...
                            if fake_order:
                                ...
                                first_exec_qty_check, check_time, open_exec = bank_module.check_breakout_qty(first_exec_qty_check,
                                                                                                             check_time,
                                                                                                             post_order_res,
                                                                                                             open_quantity)
                                if open_exec:
