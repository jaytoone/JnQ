...
# print("os.getcwd() in trader", os.getcwd())
# traders_dir = os.path.dirname(os.path.realpath(__file__))
# project_dir = os.path.dirname(traders_dir)
# pkg_path = os.path.realpath(project_dir)
...
class Trader:
    ...
    def run(self):
        ...
        config_path = os.path.join(pkg_path, "config", self.config_name)

        sys_log_path = os.path.join(pkg_path, "sys_log", exec_file_name)
        print("config_path :", config_path)
        print("sys_log_path :", sys_log_path)
        # quit()
        ...
        while 1:
            ...
            if initial_run:
                ...
                sys_log.info('# ----------- {} on {} ----------- #'.format(exec_file_name, config.trader_set.symbol))
