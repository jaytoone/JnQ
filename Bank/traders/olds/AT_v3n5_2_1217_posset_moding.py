            ...
            while 1:
                ...
                if ep_loc_check:
                    ...
                    if ep_loc_pointcnt == 0:
                        ...
                        if self.utils is not None:
                            ep_loc_pointcnt = 1
                            #      Todo     #
                            #        1. initial_ep 를 만들지말고, res_df_intial 을 이곳에서 저장
                ...
                if open_side is not None:
                    ...
                    if strat_version == "v5_2":
                        if ep_loc_pointcnt == 1:    # => 이거는 당연한 거자나, open_side != None 이면 point 체결이 존재했다는 의미인데
                            # print("v5_2 passed")
                            #        1. ei_k set       #
                            #        2. 위아래에 e_j 수정
                ...
                while 1:
                    ...
                    if datetime.timestamp(res_df.index[-1]) < datetime.now().timestamp():
                        ...
                        #       ep_loc params. 초기화
                        if strat_version == "v5_2" and ep_loc_pointcnt == 1:
                            pass
                        else:
                            ep_loc_pointcnt = 0
                            self.utils = None
