...
def short_ep_loc(res_df, config, i, np_timeidx, show_detail=True):
    ...
    if config.loc_set.zone.short_spread != "None":
        ...
        if show_detail:
            sys_log.warning("spread >= config.loc_set.zone.short_spread : {:.5f} >= {:.5f} ({})".format(spread,
    ...
    if config.loc_set.zone.dt_k != "None":
        ...
        if config.loc_set.zone.dtk_dc_itv != "None":
            ...
            if show_detail:
                sys_log.warning("dc >= dt_k : {:.5f} >= {:.5f} ({})".format(dc, dt_k, const_))
    ...
    if config.loc_set.zone.zone_rejection:
        ...
        if strat_version in ['v5_2']:
            ...
            if show_detail:
                sys_log.warning("bb_upper2_ < close : {:.5f} < {:.5f} ({})".format(bb_upper2_, close, const_))
            ...
            # const_ = close < bb_base_4h
            # if show_detail:
            #     sys_log.warning("close < bb_base_4h : {:.5f} < {:.5f} ({})".format(close, bb_base_4h, const_))
            #
            # mr_const_cnt, mr_score = mr_calc(mr_const_cnt, mr_score, const_, res_df, open_side, zone, show_detail)
        ...
        if strat_version in ['v7_3', '1_1']:
            ...
            if show_detail:
                sys_log.warning("bb_upper_5m < bb_base_ : {:.5f} < {:.5f} ({})".format(bb_upper_5m, bb_base_, const_))
        ...
        if strat_version in ['v7_3', '1_1']:
            ...
            if show_detail:
                sys_log.warning("dc_upper_5m < ema_5m : {:.5f} < {:.5f} ({})".format(dc_upper_5m, ema_5m, const_))
        ...
        if strat_version in ['v5_2']:
            ...
            const_ = close < ema_5m
            if show_detail:
                sys_log.warning("close < ema_5m : {:.5f} > {:.5f} ({})".format(close, ema_5m, const_))
            ...
            # if show_detail:
            #   sys_log.warning("bb_upper_30m > ema_5m : {:.5f} > {:.5f} ({})".format(bb_upper_30m, ema_5m, const_))
        ...
        #       if show_detail:
        #         sys_log.warning("close & st : {:.5f} {:.5f} ({})".format(bb_, bb_1, const_))
...
def long_ep_loc(res_df, config, i, np_timeidx, show_detail=True):
    ...
    if config.loc_set.zone.long_spread != "None":
        ...
        if show_detail:
            sys_log.warning("spread >= config.loc_set.zone.long_spread : {:.5f} >= {:.5f} ({})".format(spread,
    ...
    if config.loc_set.zone.zone_rejection:
        ...
        if strat_version in ['v5_2']:
            ...
            if show_detail:
                sys_log.warning("bb_lower2_ > close : {:.5f} > {:.5f} ({})".format(bb_lower2_, close, const_))
            mr_const_cnt, mr_score = mr_calc(mr_const_cnt, mr_score, const_, res_df, open_side, zone, show_detail)
        ...
        if strat_version in ['v7_3', '1_1']:
            ...
            if show_detail:
                sys_log.warning("bb_lower_5m > bb_base_ : {:.5f} > {:.5f} ({})".format(bb_lower_5m, bb_base_, const_))
            ...
            if show_detail:
                sys_log.warning("bb_lower_5m < long_ep_ : {:.5f} < {:.5f} ({})".format(bb_lower_5m, long_ep_, const_))
        ...
        if strat_version in ['v7_3', '1_1']:
            ...
            if show_detail:
                sys_log.warning("dc_lower_5m > ema_5m : {:.5f} > {:.5f} ({})".format(dc_lower_5m, ema_5m, const_))
        ...
        if strat_version in ['v5_2']:
            ...
            # if show_detail:
            #     sys_log.warning("bb_lower_30m < ema_5m : {:.5f} < {:.5f} ({})".format(bb_lower_30m, ema_5m, const_))
        ...
        #       if show_detail:
        #         sys_log.warning("close & ema : {:.5f} {:.5f} ({})".format(bb_, bb_1, const_))
