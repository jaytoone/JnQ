...
trader_name = "AT.traders.AT_v3n5_2_1222_emergency.py".replace(".py", "")
utils_public_name = "AT.utils.utils_public_1220.py".replace(".py", "")
utils1_name = "AT.utils.utils_v3_1216.py".replace(".py", "")
utils2_name = "AT.utils.utils_v5_2_1216.py".replace(".py", "")
config1_name = "config_v3_1220_candle.json"
