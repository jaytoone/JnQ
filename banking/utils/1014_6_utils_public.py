...
def lvrg_set_v2(balance, config, open_side, ep1_1, ep1_0, fee, limit_leverage=50):

    if not pd.isnull(ep1_1) and not config.lvrg_set.static_lvrg:
        if open_side == OrderSide.SELL:
            wave_range = (ep1_0 / ep1_1)
        else:
            wave_range = (ep1_1 / ep1_0)
