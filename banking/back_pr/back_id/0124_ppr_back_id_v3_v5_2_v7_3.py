    ...
    for key in ftr_list:
        ...
        for survey_i, just_loop in enumerate(range(1)):
            ...
            try:
                ...
                print("config.loc_set.point.front_wick_score :", config.loc_set.point.front_wick_score)
                print("config.loc_set.point.body_score :", config.loc_set.point.body_score)
                print("config.loc_set.point.back_wick_score :", config.loc_set.point.back_wick_score)
                print("config.loc_set.point.front_wick_score2 :", config.loc_set.point.front_wick_score2)
                print("config.loc_set.point.body_score2 :", config.loc_set.point.body_score2)
                print("config.loc_set.point.back_wick_score2 :", config.loc_set.point.back_wick_score2)
                        ...
                        if not config.tp_set.non_tp:
                            ...
                            if config.tp_set.tp_type == 'MARKET' or (config.tp_set.tp_type == "BOTH" and not trade_done):
                                ...
                                if config.tp_set.time_tp:
                                    if np_timeidx[
                                        j] % config.loc_set.zone.c_itv_ticks == config.loc_set.zone.c_itv_ticks - 1:  # and j - initial_i >= config.loc_set.zone.c_itv_ticks:
                                        market_tp = 1
