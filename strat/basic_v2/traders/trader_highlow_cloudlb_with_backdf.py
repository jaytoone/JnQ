    ...
    def run(self):
        ...
        while 1:
            ...
            while 1:
                ...
                if entry_const_check:
                    ...
                    try:
                        ...
                        under_top = res_df['high'].shift(self.close_shift_size) <= cloud_top.shift(self.cloud_shift_size)
                        over_bottom = res_df['low'].shift(self.close_shift_size) >= cloud_bottom.shift(self.cloud_shift_size)
            ...
            #       position / 체결량 이 존재하면 close order 진행      #
                ...
                #            save exit data         #
                #            exit_timeindex use "-2" index, cause back_df is lastest dataframe          #
                exit_timeindex = str(back_df.index[-2])
