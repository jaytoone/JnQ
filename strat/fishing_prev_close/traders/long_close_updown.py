...
from strat.fishing_prev_close.utils import arima_profit, calc_train_days, tp_update, interval_to_min
...
class ARIMA_Bot:
    ...
    def run(self):
        ...
        h_ohlcv_path = './fishing_prev_close/%s_history.xlsx' % self.symbol
