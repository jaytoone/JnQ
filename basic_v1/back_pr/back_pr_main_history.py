...
if __name__ == "__main__":
    ...
    #       1. concat_candle ver.      #
    new_df, _ = concat_candlestick(symbol, interval, days=days, end_date=date, timesleep=0.2)

    # print(type(new_df.index[0]))

    new_df2, _ = concat_candlestick(symbol, interval2, days=days, end_date=date, timesleep=0.2)
    ...
    print("back_pr_history.xlsx saved !")
